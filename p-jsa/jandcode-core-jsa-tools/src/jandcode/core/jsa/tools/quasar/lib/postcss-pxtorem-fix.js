...
const filterPropList = require("postcss-pxtorem/lib/filter-prop-list");
const type = require("postcss-pxtorem/lib/type");
...
module.exports = postcss.plugin("postcss-pxtorem", options => {
  ...
  return css => {
    ...
    css.walkDecls((decl, i) => {
      ...
      //ks
      if (onHandle) {
        onHandle(css, decl, i, value, origValue)
      } 
    });
