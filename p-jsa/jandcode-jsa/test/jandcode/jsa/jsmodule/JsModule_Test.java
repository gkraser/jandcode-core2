...
public class JsModule_Test extends Web_Test {
    ...
    public void req1() throws Exception {
        JsModule m = svc.findModule("jandcode/jsa/data/mods/m3.js");
    ...
    public void gsp1() throws Exception {
        JsModule m = svc.findModule("jandcode/jsa/data/mods/m5.js");
    ...
    public void dynamic1() throws Exception {
        JsModule m = svc.findModule("jandcode/jsa/data/mods/m6-dynamic.js");
    ...
    public void importModule1() throws Exception {
        JsModule m = svc.findModule("jandcode/jsa/data/mods/m7-import-module.js");
    ...
    public void css1() throws Exception {
        JsModule m = svc.findModule("jandcode/jsa/data/css/q1.css");
    ...
    public void less1() throws Exception {
        JsModule m = svc.findModule("jandcode/jsa/data/css/q3.less");
    ...
    public void reqExternal1() throws Exception {
        JsModule m = svc.findModule("jandcode/jsa/data/mods/m8-req.js");
        ...
        //
        assertEquals(m.getRequires().toString(), "[./m1=>[jandcode/jsa/data/mods/m1.js], ./m2=>[jandcode/jsa/data/mods/m2.js]]");
    }
