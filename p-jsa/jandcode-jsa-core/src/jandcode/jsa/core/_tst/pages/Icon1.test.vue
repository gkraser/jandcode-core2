<template>
    <tst-panel class="icon1-59f8b2d7">
        ...
        <div>
            ...
            <div class="bg">
                <span>Это png</span>
                <jc-icon url="jandcode/jsa/core/_tst/pages/images/logo1.png"></jc-icon>
                <span>Это svg</span>
                <jc-icon url="jandcode/jsa/core/_tst/pages/images/logo3.svg"></jc-icon>
                <template v-for="sz in iconSizesPx()">
                    <span>{{sz}}px</span>
                    <jc-icon url="jandcode/jsa/core/_tst/pages/images/logo1.png"
                             :style="{width:''+sz+'px',height:''+sz+'px'}" :class="'qaz3'"
                    ></jc-icon>
                    <jc-icon url="jandcode/jsa/core/_tst/pages/images/logo3.svg"
