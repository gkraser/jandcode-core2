    ...
    <tst-panel class="toolbar1-59f93114">
        ...
        <div v-for="n in 2" :class="'row row-'+n">
            ...
            <jc-toolbar>
                ...
                <jc-toolbar-logo url="jandcode/jsa/core/_tst/pages/images/logo1.png"
                                 @click="logoClick"/>
                <jc-action text="Action2"/>
                <jc-toolbar-logo url="jandcode/jsa/core/_tst/pages/images/logo3.svg"
                                 @click="logoClick"/>
                <jc-action text="Action3"/>
                <jc-toolbar-logo
                        url="jandcode/jsa/core/_tst/pages/images/logo5-long.png"
                        @click="logoClick"/>
                <jc-action text="Action4"/>
                <jc-toolbar-logo
                        url="jandcode/jsa/core/_tst/pages/images/logo6-long.svg"
                        @click="logoClick"/>
