...
public class AppConfHandler1 implements AppConfHandler {
    ...
    public void handleModuleConf(ModuleInst module, ModuleInst moduleOwner, Conf conf) throws Exception {
    ...
    public void handleAppConf(App app, ModuleInst moduleOwner, Conf conf) throws Exception {
        String mn = "";
