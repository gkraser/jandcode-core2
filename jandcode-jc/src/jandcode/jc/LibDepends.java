...
public interface LibDepends {
    ...
    /**
     * Группа: exdev.
     * Библиотеки в этой группе используются как расширенные dev-зависимости,
     * которые становтся зависимостями в dev-режиме.
     * Такие библиотеки автоматически включаются в classpath при использовании
     * библиотеки в jc.
     */
    LibDependsGroup getExdev();
