...
import jandcode.web.virtfile.impl.filetype.*;
import jandcode.web.virtfile.impl.virtfs.*;
...
public class VirtFileServiceImpl extends BaseComp implements VirtFileService {
    ...
    public jandcode.web.virtfile.FileType findFileType(String name) {
        return fileTypeHolder.find(name);
    }

    public List<jandcode.web.virtfile.FileType> getFileTypes() {
