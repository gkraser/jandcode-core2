...
import jandcode.core.web.gsp.impl.*;
...
public abstract class BaseGsp extends GspImpl {
     ...
     * <p>
     * Например, шаблон находится в файле '/jandcode/core/web/tst/template.gsp', тогда:
     * path('a.css') => '/jandcode/core/web/tst/a.css'
     * path('b/a.css') => '/jandcode/core/web/tst/b/a.css'
     * path('../a.css') => '/jandcode/core/web/a.css'
     *
