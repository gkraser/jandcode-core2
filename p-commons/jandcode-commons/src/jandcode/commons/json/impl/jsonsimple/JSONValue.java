 ...
 */
package jandcode.commons.json.impl.jsonsimple;

import jandcode.commons.json.impl.jsonsimple.ext.*;
import jandcode.commons.json.impl.jsonsimple.parser.*;
...
public class JSONValue {
    ...
    public static void writeJSONString(Object value, Writer out) throws IOException {
        ...
        String res = JSONValueConvertorManager.getInst().toJsonString(value);
        if (res != null) {
            out.write('\"');
            out.write(escape(res));
            out.write('\"');
        }
